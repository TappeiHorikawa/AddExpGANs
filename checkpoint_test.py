...
class SGAN():
    ...
    @tf.function
    def train_step(self, batch_size, imgs, labels, imgs_unlabeled):
    ...
    def train(self, iterations,batch_size,sample_interval):
        ...
        for iteration in range(iterations):
            ...
            g_loss, d_loss_supervised, d_loss_unsupervised = self.train_step(tf.constant(batch_size), tf.constant(imgs), tf.constant(labels), tf.constant(imgs_unlabeled))
